...
Sample packs are expensive. A decent multisampled piano runs $50-200. A comprehensive drum library is another $100+. A full orchestral collection can cost thousands. And you're buying someone else's recordings of someone else's instruments in someone else's room.
...
And because the source code is included, you can regenerate everything. Want longer samples? Change a parameter. Want different tunings? Change a parameter. Want an instrument that doesn't exist yet? Add it to PyTheory and re-run the generator. Try doing that with a $200 sample pack.
