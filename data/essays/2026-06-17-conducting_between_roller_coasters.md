...
And none of it stayed put. The same features went everywhere PyTheory lives: into [the browser playground](https://playground.pytheory.org) with nothing to install, and into [the Ableton Live extension](https://github.com/kennethreitz/ableton-pytheory/releases/latest), so you can reharmonize a clip or print a raga without leaving your session.
