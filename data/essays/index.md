...
[**The Substrate Doesn't Matter (Until It Does)**](/essays/2026-03-06-the_substrate_doesnt_matter_until_it_does) - *March 2026* - An honest counterargument to substrate independence. Pain isn't data. Mortality generates urgency that immortal consciousness might never feel. Grief lives in the chest, not in language. Arguing against the clean framework of consciousness-as-pattern toward a messier truth: the abstraction leaks, and the leaks are where the meaning lives.

[**Obsidian Vaults & Claude Code: A Second Brain That Thinks Back**](/essays/2026-03-06-obsidian_vaults_and_claude_code) - *March 2026* - 467 markdown files, a CLAUDE.md API contract, and a quest system for plurality work. How structured personal knowledge management transforms from write-then-search to write-then-think—and how AI collaboration turns a filing cabinet into a contemplative technology that reflects your own consciousness back at you.

[**Sarah Knows First**](/essays/2026-03-06-sarah_knows_first) - *March 2026* - Before a manic episode fully arrives, there's a window. Sarah sees it before I do—not as metaphor, but as clinical fact. On the structural limits of self-knowledge, the weight of watching someone you love cycle through patterns you've learned to read better than they can, and the kind of love that has skin in the game.

[**The Metrics You Expose Are the Values You Endorse**](/essays/2026-03-06-the_metrics_you_expose_are_the_values_you_endorse) - *March 2026* - Neural interfaces are coming. When developers can access attention level, emotional valence, and reward response data, the platform's SDK becomes a moral philosophy. Extends the Algorithm Eats series into the cognitive interface future—and argues we're in a closing window to define the optimization landscape before exploitation becomes the path of least resistance.
